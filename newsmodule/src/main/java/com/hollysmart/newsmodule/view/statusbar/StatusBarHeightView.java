package com.hollysmart.newsmodule.view.statusbar;
...
public class StatusBarHeightView extends LinearLayout {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.news_module_StatusBarHeightView);
            type = typedArray.getInt(R.styleable.news_module_StatusBarHeightView_use_type, 0);
            typedArray.recycle();
        }
        if (type == 1) {
